...
public static class Tags
{
    ...
    public const string PackageLicenseExpression = "PackageLicenseExpression";
    public const string SymbolPackageFormat = "SymbolPackageFormat";
    public const string PackageProjectUrl = "PackageProjectUrl";
    ...
    public const string GenerateAssemblyDescriptionAttribute = "GenerateAssemblyDescriptionAttribute";

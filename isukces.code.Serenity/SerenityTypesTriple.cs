...
namespace iSukces.Code.Serenity
{
    ...
    {
        public SerenityTypesTriple(Type facade, Type fieldWrapped, string rowFieldType)
        {
            Facade       = facade;
        ...
        public static SerenityTypesTriple FromType(Type t)
        {
            ...
            if (w.IsEnum)
            {
                ...
                switch (code)
                {
                    case TypeCode.Int32: return new SerenityTypesTriple(nullableEnum, typeof(int?), "Int32Field");
                    case TypeCode.Int16: return new SerenityTypesTriple(nullableEnum, typeof(short?), "Int16Field");
                    default:
        ...
        {
            return new SerenityTypesTriple(typeof(T), typeof(T), field);
        }

        public Type   Facade       { get; }
        public Type   FieldWrapped { get; }
        public string RowFieldType { get; }
    }
}
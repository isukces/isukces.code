...
public class SequenceRuleBuilder
{
    ...
    public                  Func<ITokenNameSource, AstTypesInfoDelegate> ProcessToken { get; set; } = null!;
    public                  Func<ITokenNameSource, TokenInfoResult> GetTokenInfoByName { get; set; } = null!;
